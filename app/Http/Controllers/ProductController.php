...
use App\Models\{Product,category,rate};
...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->search) {
            $products = $products->where('name', 'LIKE', "%{$request->search}%")->orWhere('Model','LIKE',"{$request->search}");
        }
    ...
    public function create()
    {
        ...
        }return back()->with('error', 'Sorry, you have to create a category first.');
